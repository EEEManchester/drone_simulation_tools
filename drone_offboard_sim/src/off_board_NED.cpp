...
int main(int argc, char **argv)
{
    ...
    position_ref.coordinate_frame = mavros_msgs::PositionTarget::FRAME_BODY_NED;
    ...
    position_ref.position.x = position_ref_NED(0);
    position_ref.position.y = position_ref_NED(1);
    position_ref.position.z = position_ref_NED(2);
